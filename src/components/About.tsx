...
const educationData: EducationItem[] = [
  {
    ...
    institution:
      "SRM Institute of Science and Technology (8.5 CGPA)",
    period: "2022 - 26",
    description:
      "Specialised in Software Developent and core Computer Application skills.",
  },
  {
    degree: "12th",
    ...
    period: "2021 - 22",
    description:
      "Specialized in human-computer interaction and advanced software development methodologies.",
  },
];
          ...
          <div>
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Yo! I'm an app developer turning
                caffeine and code into sleek,
                high-performance mobile apps. With
                a year of freelance and internship
                experience in Flutter, I craft
                smooth UIs and clean code. Always
                leveling up — React Native,
                Node.js, you name it. Goal? Build
                cool stuff and break barriers!
              </p>
